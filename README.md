...
* **오프닝 탭** — 백/흑 오프닝을 가로 스크롤 캐러셀에서 고르고, 보드 위 화살표를 따라 수순을 한 수씩 익힙니다. 상대의 수는 자동으로 둬지고, 수순을 벗어난 수를 두면 화면 테두리가 빨갛게 번쩍이며 자동으로 되돌아갑니다. 아무 포지션에서나 "이 포지션 분석하기"로 엔진 분석 화면에 진입할 수 있습니다.
...
* 오프닝 수순에 수별 해설 문구가 없습니다(현재는 수 자체만 안내).
